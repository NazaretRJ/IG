...
escena = new Escena();
//para ply
if(argc==2 && (!strcmp(argv[1],"-p") || !strcmp(argv[1],"-P"))){ //le hemos puesto la opción
	string nm;
	cout <<"Introduzca el nombre del archivo"<<endl;
	cin >> nm;
	escena->CambiaArchivo(nm);
}
...
glutCreateWindow("Practica 4: Maria Nazaret Ruiz Jaldo");
